...
function M.make_font()
  local gstr = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@,.;/"
  M.font_img = love.graphics.newImage("generated/font_chinese.png")
...
function M.draw_status(msg)
  if msg then
    ...
    love.graphics.print(msg, M.vw / 2 - w / 2, M.vh / 2 - 12)
    love.graphics.setColor(255, 255, 255, 255)
  end
end
